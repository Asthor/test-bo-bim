  ...
  render() {
    return (
      <div className={s.container}>
        ...
        {this.state.selected === 0 && <div className={s.tabcontent}>
          ...
          <div className={s.identity}>
            ...
            <div className={s.right}>
              ...
              <span className={s.text}>Date de naissance: 00/00/0000 (00ans)</span>
          ...
          <button className={s.button} onClick={() => this.setState({selected: 3})}>{this.props.menu4}</button>
        </div>}
        ...
        {this.state.selected === 2 && <div className={s.tabcontent}>
          ...
          <div className={s.adminContainer}>
            <div className={s.adminLeft}>
              ...
              <button className={s.button} onClick={() => this.setState({selected: 3})}>{this.props.menu5}</button>
            </div>
        ...
        {this.state.selected === 3 && <div className={s.tabcontent}>
          <span className={s.title}>Modifier les informations personnelles</span>
          ...
          <div className={s.buttonContainer}>
            <button className={s.buttonValid} onClick={() => this.setState({selected: 0})}>{this.props.menu5}</button>
            <button className={s.buttonCancel} onClick={() => this.setState({selected: 0})}>{this.props.menu6}</button>
          </div>
        </div>}
      </div>
    );
